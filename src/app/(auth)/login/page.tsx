...
import { Eye, EyeOff, AlertCircle, CheckCircle, Coins, Mail, Lock } from 'lucide-react';
...
if (typeof window !== 'undefined') {
  document.title = 'User Login - Investogold';
}
            ...
            >
              <div className="relative mb-8">
                <div className="w-24 h-24 bg-gradient-to-r from-yellow-500 to-amber-500 rounded-3xl flex items-center justify-center mx-auto shadow-2xl shadow-yellow-500/25">
                  <Coins className="h-12 w-12 text-black" />
                </div>
              ...
              <p className="text-xl text-gray-200 mb-12 leading-relaxed">
                The future of gold investment is here. Join thousands of investors who trust our advanced AI-powered gold trading platform.
              </p>
              ...
              <div className="space-y-6 text-left">
                ...
                >
                  ...
                  <span className="text-gray-200 font-medium">AI-Powered Gold Trading</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="text-gray-200 font-medium">Real-time Gold Market Data</span>
                </motion.div>
                ...
                >
                  ...
                  <span className="text-gray-200 font-medium">Secure Investment Platform</span>
                </motion.div>
              </div>
            </motion.div>
          </div>
            ...
            <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl p-8 border border-white/20">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="login-input w-full pl-12 pr-4 py-4 bg-white border border-gray-200 rounded-xl placeholder-gray-500 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20 focus:outline-none transition-all duration-200"
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative overflow-hidden rounded-xl">
                    ...
                    <input
                      ...
                      className="login-input w-full pl-12 pr-12 py-4 bg-white border border-gray-200 rounded-xl placeholder-gray-500 focus:border-yellow-500 focus:ring-2 focus:ring-yellow-500/20 focus:outline-none transition-all duration-200"
                ...
                <button
                  type="submit"
                  disabled={isLoading}
                  className="w-full bg-gradient-to-r from-yellow-500 via-amber-500 to-yellow-600 text-black font-semibold py-4 px-6 rounded-xl hover:from-yellow-600 hover:via-amber-600 hover:to-yellow-700 focus:ring-2 focus:ring-yellow-500/20 focus:outline-none transition-all duration-200 transform hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none shadow-lg shadow-yellow-500/25"
                >
                  {isLoading ? (
